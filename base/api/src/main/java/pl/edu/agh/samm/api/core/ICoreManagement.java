...
import pl.edu.agh.samm.api.sla.ServiceLevelAgreement;
...
public interface ICoreManagement {
     ...
     *            computed
     */
    void startMetricAndAddRunningMetricListener(IMetric runningMetric, IMetricListener listener);
     ...
     */
    void updateMetricPollTimeInterval(IMetric metric) throws MetricNotRunningException;
     ...
     * @return metric
     */
    IMetric createRunningMetricInstance(String metricURI, String resourceURI);
